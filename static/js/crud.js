...
$(function () {
    var loadForm = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#modal-lg .modal-content").html(data.html_user_characteristic_form);
                $("#user-class").autocomplete({
                    source: "/account/dashboard/user_characteristic_autocomplete/",
                    minLength: 1,
    ...
    $("#modal-lg").on("submit", ".js-user-characteristic-add-form", saveForm);
    // Update User Characteristic
    $("#user-characteristic-list").on("click", "#js-edit-user-characteristic-button", loadForm);
    $("#modal-lg").on("submit", ".js-user-characteristic-edit-form", saveForm);
});
...
$(function () {
    var loadForm = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#modal-lg .modal-content").html(data.html_purpose_form);
            }
        });
    };
    var saveForm = function () {
    ...
    $("#modal-lg").on("submit", ".js-purpose-add-form", saveForm);
    // Update Purpose
    $("#purpose-list").on("click", "#js-edit-purpose-button", loadForm);
    $("#modal-lg").on("submit", ".js-purpose-edit-form", saveForm);
});
...
$(function () {
    var loadForm = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#modal-lg .modal-content").html(data.html_creation_goal_form);
            }
        });
    };
    var saveForm = function () {
    ...
    $("#modal-lg").on("submit", ".js-creation-goal-add-form", saveForm);
    // Update Creation Goal
    $("#creation-goal-list").on("click", "#js-edit-creation-goal-button", loadForm);
    $("#modal-lg").on("submit", ".js-creation-goal-edit-form", saveForm);
});
...
$(function () {
    var loadForm = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#modal-lg .modal-content").html(data.html_object_information_form);
            }
        });
    };
    var saveForm = function () {
    ...
    $("#modal-lg").on("submit", ".js-object-information-add-form", saveForm);
    // Update Object Information
    $("#object-information-list").on("click", "#js-edit-object-information-button", loadForm);
    $("#modal-lg").on("submit", ".js-object-information-edit-form", saveForm);
});
