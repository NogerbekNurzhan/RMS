...
class RegistrationAdmin(admin.ModelAdmin):
    ...
    def resend_activation_email(self, request, queryset):
        ...
        Note that this will *only* send activation emails for users who are eligible to activate; emails will not be sent to users  whose activation keys have expired or who have already activated.
        """
