...
class DefaultBackendViewTests(TestCase):
    ...
    def test_registration_get(self):
        """
        HTTP ``GET`` to the account view uses the appropriate
        template and populates a account form into the context.
    ...
    @override_settings(
        INSTALLED_APPS=('django.contrib.auth', 'account',)
    )
    ...
    def test_resend_activation(self):
        ...
        self.assertTemplateUsed(resp,
                                'account/reactivation_complete.html')
