...
from account.models import SupervisedRegistrationProfile
from account.backends.admin_approval.views import RegistrationView
...
class AdminApprovalBackendViewTests(DefaultBackendViewTests):
    """
    Test the admin_approval account backend.
