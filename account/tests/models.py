...
from account.models import RegistrationProfile, SupervisedRegistrationProfile
...
class RegistrationModelTests(TestCase):
    ...
    def setUp(self):
        ...
        settings.REGISTRATION_DEFAULT_FROM_EMAIL = 'account@email.com'
    ...
    def test_activation_email_uses_registration_default_from_email(self):
        ...
        profile = self.registration_profile.objects.create_profile(new_user)
        profile.send_activation_email(Site.objects.get_current())
        self.assertEqual(mail.outbox[0].from_email, 'account@email.com')
    ...
    def test_activation_nonexistent_key(self):
        ...
        # account, this will never be a valid key.
